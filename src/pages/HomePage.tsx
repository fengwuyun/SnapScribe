...
export function HomePage({ onNavigate }: { onNavigate: (route: AppRoute) => void }) {
  ...
  async function toggleRecording() {
    ...
    try {
      if (!recording) {
        const started = await ipc.recordingStart();
